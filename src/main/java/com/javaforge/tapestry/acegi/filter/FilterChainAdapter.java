...
{
    private final ServletRequestServicer servicer;

    public FilterChainAdapter(ServletRequestServicer servicer)
    {
    ...
    {
        servicer.service((HttpServletRequest) servletRequest, (HttpServletResponse) servletResponse);
    }
}
